...
const VectorTexto: React.FunctionComponent<Props> = ({ rango = null, onRefreshListado = null }) => {
        ...
        <TabPane tabId="1">
          ...
          <DataGridForm
            ...
            columns={[
              ...
              { dataField: 'valorTexto1', caption: 'Valor Texto' },
...
export default React.memo(VectorTexto)